...
public enum NutrientType {
    ...
    FIBER("fiber", "膳食纤维", "g", true, 0.5, new double[]{0.6, 1.5}, 30.0),
    CALCIUM("calcium", "钙", "mg", false, 0.0, new double[]{0.8, 1.5}, 1000.0),
    POTASSIUM("potassium", "钾", "mg", false, 0.0, new double[]{0.8, 1.5}, 3500.0),
    SODIUM("sodium", "钠", "mg", true, 0.0, new double[]{0.5, 1.0}, 2000.0),
    MAGNESIUM("magnesium", "镁", "mg", false, 0.0, new double[]{0.8, 1.5}, 350.0),
    IRON("iron", "铁", "mg", false, 0.0, new double[]{0.5, 1.5}, 10.0),
    PHOSPHORUS("phosphorus", "磷", "mg", false, 0.0, new double[]{0.5, 1.5}, 700.0),
    ZINC("zinc", "锌", "mg", false, 0.0, new double[]{0.8, 1.5}, 10.0),
    VITAMIN_A("vitamin_a", "维生素A", "μg", false, 0.0, new double[]{0.8, 1.5}, 800.0),
    VITAMIN_C("vitamin_c", "维生素C", "mg", false, 0.0, new double[]{0.8, 1.5}, 80.0),
    VITAMIN_D("vitamin_d", "维生素D", "μg", false, 0.0, new double[]{0.8, 1.5}, 10.0),
    VITAMIN_E("vitamin_e", "维生素E", "mg", false, 0.0, new double[]{0.8, 1.5}, 15.0),
    ;
