...
public class NutritionCalculator {
    ...
    public NutrientRatio calculateNutrientRatio() {
        HealthConditionType[] conditions = getHealthConditions();
     ...
     * @return 健康状况数组
     */
    private HealthConditionType[] getHealthConditions() {
        if (userProfile == null) {
            return new HealthConditionType[0];
        }
        
        String[] conditionNames = userProfile.getHealthConditions();
        return HealthConditionType.fromNames(conditionNames);
    }
